...
var fx = {
    ...
    displayPopup: function (title, content, func, useOverlay) {
        ...
        var html =
            '<div class="modals modals-light" id="popup-container" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" style="display: block; position:static; width: auto; outline: none;max-width:100%;">\
			<div class="modals-dialog" style="width: auto; min-width: 400px;">\
				<div class="modals-content">\
				<div class="modals-header">\
					<button type="button" class="close btn-close-popup fxClose" data-dismiss="modals" aria-hidden="true">×</button>\
					<h4 class="modals-title" id="popup-header">' +
            title +
            '</h4>\
				</div>\
				<div class="modals-body" id="popup-body" style="padding: 20px;">\
				' +
            content +
            '	\
				</div>\
				<!-- div class="modals-footer" id="popup-footer">\
...
fx.messageBox = function (title, message, buttons, callback, useOverlay) {
    ...
    var html =
        '<div class="modals modals-light messagebox-container" id="' +
        messageBoxId +
        '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" style="display: block; position:static; width: auto; outline: none;max-width:100%;box-sizing:border-box;-webkit-box-sizing:border-box;">\
			<div class="modals-dialog" style="width: auto; min-width: 320px;">\
				<div class="modals-content">\
				<div class="modals-header">\
					<button type="button" class="close btn-close-popup fxClose" data-dismiss="modals" aria-hidden="true">×</button>\
					<h4 class="modals-title" id="popup-header">' +
