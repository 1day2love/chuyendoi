$(document).ready(function(){
   ...
   //Suggest email khi Ä‘Äƒng kÃ½ nháº­n mail
   $("#sub_email").keyup(function(){	
    ...
    $(".btn-login").click(function(){
        $this = $(this);
        $this.html('<img src="/images/spinner.gif" /> Vui lÃ²ng chá»...');
...
_loadFbSDk=function(){(function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(d.getElementById(id))return;js=d.createElement(s);js.id=id;js.src="//connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v16.0&appId=896535841224336&autoLogAppEvents=1";fjs.parentNode.insertBefore(js,fjs);}(document,'script','facebook-jssdk'));}
