...
<div class="mb-4">
    <div class="p-0">
        <div class="input-group mb-3 col-md-6 px-0">
            <input id="new-server-name" type="text" value="#Thuyết Minh" placeholder="Tên server" class="form-control">
        ...
        <ul class="nav nav-tabs" role="tablist" id="episode-server-list">
            ...
            @else
                <li class="nav-item"><a class="nav-link episode-server active" data-toggle="tab"
                        ...
                        contenteditable onblur="updateEpisodeServer(this)">
                        #Vietsub</a>
                </li>
            @endif
        </ul>
                        ...
                        <div class="table-responsive mb-3">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($sortedEpisodes->sortBy('id') as $episode)
                                    <tr class="episode">
                                        ...
                                        <td>
                                            <select name="episodes[{{ $index }}][type]"
                                                ...
                                                @foreach (config('kkphim.episodes.types', []) as $key => $name)
                                                    <option value="{{ $key }}"
                            ...
                            <tbody>
                                <tr class="episode">
                                    <input type="hidden" class="episode-server" name="episodes[0][server]"
                                        value="#Vietsub" data-attr-name="server">
