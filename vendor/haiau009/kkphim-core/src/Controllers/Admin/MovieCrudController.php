...
namespace KKPhim\Core\Controllers\Admin;

use KKPhim\Core\Requests\MovieRequest;
 ...
 * @package KKPhim\Core\Controllers\Admin
...
class MovieCrudController extends CrudController
{
    ...
    use \KKPhim\Core\Traits\Operations\BulkDeleteOperation {
    ...
    {
        CRUD::setModel(\KKPhim\Core\Models\Movie::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/movie');
        CRUD::setEntityNameStrings('movie', 'movies');
        CRUD::setCreateView('kkphim::movies.create',);
        CRUD::setUpdateView('kkphim::movies.edit',);
    }
    ...
    {
        //$this->crud->query = $this->crud->query->orderBy('updated_at', 'desc');
        ...
        $this->crud->addClause('where', 'is_published', $val);
        });
        ...
        CRUD::addColumn([
            ...
            'label' => 'Thông tin',
            'type' => 'view',
            'view' => 'kkphim::movies.columns.column_movie_info',
        ...
        CRUD::addColumn([
            ...
            'width'  => '68px',
            'type' => 'view',
            'view' => 'kkphim::movies.columns.column_thumb_info',
        ]);
        ...
        // xuất bản hoặc nháp
        //CRUD::addColumn(['name' => 'is_published','label' => 'Xuất bản','type' => 'boolean',]);
    }
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            'name' => 'episodes',
            'type' => 'view',
            'view' => 'kkphim::movies.inc.episode',
            'tab' => 'Danh sách tập phim'
        ],);

        CRUD::addField(['name' => 'update_handler', 'label' => 'Trình cập nhật', 'type' => 'select_from_array', 'options' => collect(config('kkphim.updaters', []))->pluck('name', 'handler')->toArray(), 'tab' => 'Cập nhật']);
        CRUD::addField(['name' => 'update_identity', 'label' => 'ID cập nhật', 'type' => 'text', 'tab' => 'Cập nhật']);
        CRUD::addField(['name' => 'tmdb_id', 'label' => 'TMDB ID', 'type' => 'text', 'wrapperAttributes' => [
            'class' => 'form-group col-md-4'
        ], 'attributes' => ['placeholder' => 'id tmdb'], 'tab' => 'Cập nhật']);
        CRUD::addField(['name' => 'imdb_id', 'label' => 'IMDB ID', 'type' => 'text', 'wrapperAttributes' => [
            'class' => 'form-group col-md-4'
        ], 'attributes' => ['placeholder' => 'id imdb'], 'tab' => 'Cập nhật']);
        ...
        */
        CRUD::addField(['name' => 'is_shown_in_theater', 'label' => 'Phim chiếu rạp', 'type' => 'switch', 'tab' => 'Khác']);
        CRUD::addField(['name' => 'is_copyright', 'label' => 'Có bản quyền phim', 'type' => 'switch', 'tab' => 'Khác']);
        CRUD::addField(['name' => 'is_sensitive_content', 'label' => 'Cảnh báo nội dung người lớn', 'type' => 'switch', 'tab' => 'Khác']);
        CRUD::addField(['name' => 'is_recommended', 'label' => 'Đề cử', 'type' => 'switch', 'tab' => 'Khác']);
        //Đã xuất bản hoặc chưa xuất bản
        CRUD::addField(['name' => 'is_published','label' => 'Hiển thị','type' => 'switch','default' => true,'tab' => 'Khác',]);
    }
