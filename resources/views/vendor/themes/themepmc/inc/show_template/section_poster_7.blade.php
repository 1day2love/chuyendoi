<div class="block">
    <div class="heading">
        ...
        <ul class="sub-heading">
               <!--             <li><a rel="nofollow" class="tab-filter" data-href="phim-bo" href="javascript:void(0)">Phim bộ</a></li>
                            <li><a rel="nofollow" class="tab-filter" data-href="phim-le" href="javascript:void(0)">Phim lẻ</a></li>
                -->
                            <li><a rel="nofollow" class="tab-filter" data-href="phim-hoan-thanh" href="javascript:void(0)">Phim đã hoàn thành</a></li>
