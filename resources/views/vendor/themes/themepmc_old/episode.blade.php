...
@section('content')
    <div class="container" id="page-player">
        ...
        <div class="box-player" id="box-player">
            ...
            <br>- Tham gia nhóm <a href="tg://join?invite=dsohJWvfjJc5NmQ1" target="_blank" rel="nofollow noopener">
            ...
            <div class="options">
                <ul class="tool">
                    <li class="off-ads"> <a href="javascript:()" id="btn-remove-ad" rel="nofollow" style="color: #ff9601;font-size: 20px;"  title="Tắt quảng cáo" >Tắt ADS <img src="/build/player/icon-noads.png" alt="off ads"/></a> </li>
...
<div id="report_error" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="p_content">
                    ...
                    <label class="rp-err">Tham gia nhóm <a href="tg://join?invite=dsohJWvfjJc5NmQ1" target="_blank" rel="nofollow noopener">
    ...
    <link href="/build/css/jwplay.css" rel="stylesheet" type="text/css">
    ...
    <script src="/js/hls.min.js?v=1"></script>
        ...
        async function renderPlayer(type, link, id) {
            ...
            if (shouldProcess) {
                if (playop.some(p => link.includes(p))) {
                    urlNoAds = `https://ads.hlsmovie.com/stream?url=${encodeURIComponent(link)}`;
            ...
            if (type == 'm3u8' || type == 'mp4') {
                ...
                player.on('error', function() {
                    // Thông báo lỗi player
                     fx.messageBox(
                        "Lỗi",
                        "Phim <strong>{{$currentMovie->name}} - {{$currentMovie->origin_name}} - {{ strpos($episode->name, 'Tập') !== false ? $episode->name : 'Tập ' . $episode->name }}</strong> bạn đang xem có thể đã bị lỗi, hãy <a href='tg://join?invite=dsohJWvfjJc5NmQ1' target='_blank'><span style='color: red; font-weight: bold;'>Nhấn Vào Đây</span></a> để báo cho chúng mình qua Telegram để được sửa lỗi sớm nhất có thể. Cảm ơn<3",
